...
public class TestSeleniumAutomationpractice {
    ...
    public void correctLoginTest() {
        ...
        driver.findElement(By.cssSelector("#email")).sendKeys("fakeaccount02@o2.pl");
        driver.findElement(By.xpath("//form[@id='login_form']/div")).click();
        driver.findElement(By.name("passwd")).sendKeys("haslo1234");
    ...
    public void incorrectRegistrationTest() {
        ...
        driver.findElement(By.name("email_create")).sendKeys("fakeaccount@wp.pl");
